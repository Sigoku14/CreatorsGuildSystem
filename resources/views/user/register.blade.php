...
<body id="index" class="index">
    ...
    <nav>
        <div id="breadcrumbs">
            <p>
                <a href="/CreatorsGuild/public/" rel="home">ホーム</a>
    ...
    <body>
        ...
        <div id="body">
            <div class="workBox">
                <form>
                    <h2 class="title"><img src="/CreatorsGuild/public/img/image/register_title.svg" alt="ユーザー登録" /></h2>
    ...
    <script type="text/javascript">
        $("#push").on('click', function() {
            ...
            $.ajax({
                type: "POST",
                url: "/CreatorsGuild/public/api/register",
