...
@section('css', '/CreatorsGuild/public/css/makeQuest.css')
...
<script type="text/javascript">
    $("body").ready(function() {
        ...
        $.ajax({
            type: "POST",
            url: "/CreatorsGuild/public/api/makeQuest",
    ...
    $("#push").on('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: "/CreatorsGuild/public/api/storeQuest",
            contentType: "Content-Type: application/json; charset=UTF-8",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
            ...
            console.log(msg);
            if (msg.status === true) {
                window.location.href = "/CreatorsGuild/public/goMadeQuest/" + user_id;
            } else {
