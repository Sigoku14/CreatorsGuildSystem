...
@section('title', '')
@section('css', '/css/questDetail.css')
...
<script type="text/javascript">
    $("body").ready(function() {
        ...
        $.ajax({
                        ...
                        swal({
                            ...
                            if (delivered) {
                                swal("ご苦労様でした。\n評価完了で完全に終了となります。", {
                                    ...
                                    if (yes) {
                                        window.location.href = "/evaluation/{{$id}}/" + value.quest_id + "/2";
                                    }
                                })
                            } else {
            ...
            for (const [key, value] of Object.entries(msg.creator)) {
                ...
                nameLink.href = "/showProfile/{{$id}}/" + value.user_id;
    ...
    $("#push").on('click', function() {
        ...
        $.ajax({
            ...
            if (msg.status === true) {
                window.location.href = "/questDetail/{{$id}}/{{$q_id}}";
            } else {
