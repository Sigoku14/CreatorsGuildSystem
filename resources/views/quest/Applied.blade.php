...
@section('css', '/CreatorsGuild/public/css/applied.css')
@include('template/header')

@section('content')
<h2 id="quests">応募中のクエスト</h2>
...
<script type="text/javascript">
    $("body").ready(function() {
        ...
        $.ajax({
            type: "POST",
            url: "/CreatorsGuild/public/api/showApplied",
            ...
            var i = 0;
            console.log(msg);
            for (const [key, value] of Object.entries(msg.applied)) {
                //外枠
                ...
                ownerName.href = "/CreatorsGuild/public/showProfile/{{$id}}/" + value.user_id;
                ...
                amountP.className = "amount-p";
                amountP.innerHTML = msg.amount[value.quest_id];
            ...
            if (i === 0) {
                ...
                noQuestTitle.innerHTML = "現在応募中のクエストはございません。";
                ...
                goQuestLink.href = "/CreatorsGuild/public/goHome/{{$id}}";
