...
@section('css', '/CreatorsGuild/public/css/ordered.css')
...
<script type="text/javascript">
    $("body").ready(function() {
        ...
        $.ajax({
            type: "POST",
            url: "/CreatorsGuild/public/api/showOrdered",
                    ...
                    swal({
                        ...
                        if (delivered) {
                            swal("ご苦労様でした。\n評価完了で完全に終了となります。", {
                                ...
                                if (yes) {
                                    window.location.href = "/CreatorsGuild/public/evaluation/{{$id}}/" + value.quest_id + "/1";
                                }
                            })
                        } else {
